  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
   ...
   if(user.isSignedIn) {
    return (
      <>
        <Head>
          ...
          <meta
            name="description"
            content="helps you to organize your next big event.. "
          />
    ...
    return (
      ...
      <div className="mt-5 bg-blue-500 text-white font-bold text-xl py-5 px-2 rounded hover:bg-blue-700 w-[15rem] flex justify-center">
        <SignInButton/>
      </div>
      </div>
      </>
